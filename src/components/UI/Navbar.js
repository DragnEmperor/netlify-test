...
const navbar=()=>{
  ...
  <div className="sm:hidden" id="mobile-menu">
    ...
    <Link to="/gallery" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Heading3</Link>

    <Link to="/gallery" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Heading4</Link>
    </div>
  </div>
</nav>
)};
